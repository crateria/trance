...
Optional **COSMIC Desktop** panel applet for the [Trance screensaver suite](https://github.com/UberMetroid/trance).
...
- [Main README](https://github.com/UberMetroid/trance) — install, upgrade path, `trance doctor --fix`
