...
| [`src/cell_renderer/font.rs`](src/cell_renderer/font.rs) | 64 | ✅ OK |
...
| [`src/discovery.rs`](src/discovery.rs) | 97 | ✅ OK |
| [`src/fps_overlay.rs`](src/fps_overlay.rs) | 93 | ✅ OK |
| [`src/launcher.rs`](src/launcher.rs) | 181 | ✅ OK |
| [`src/launcher_tests.rs`](src/launcher_tests.rs) | 122 | ✅ OK |
| [`src/lib.rs`](src/lib.rs) | 33 | ✅ OK |
| [`src/platform_helpers.rs`](src/platform_helpers.rs) | 72 | ✅ OK |
| [`src/plugin_session/loading.rs`](src/plugin_session/loading.rs) | 99 | ✅ OK |
| [`src/plugin_session/mod.rs`](src/plugin_session/mod.rs) | 203 | ✅ OK |
